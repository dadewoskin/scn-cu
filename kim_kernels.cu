...
/*
		s_dot->MnPo[n] = p->trPo[n]*(s->G[n]+LIGHT*p->lono[n]*19.9*p->lta[n]*(1.0-s->ltn[n]))+p->CtrPo[n]*s->CRE[n]-p->tmc[n]*s->MnPo[n]-p->umPo[n]*s->MnPo[n];
		s_dot->McPo[n] = -(p->umPo[n]*s->McPo[n])+p->tmc[n]*s->MnPo[n];
		s_dot->MnPt[n] = p->trPt[n]*(s->G[n]+LIGHT*p->lont[n]*19.9*p->lta[n]*(1.0-s->ltn[n]))+p->CtrPt[n]*s->CRE[n]-p->tmc[n]*s->MnPt[n]-p->umPt[n]*s->MnPt[n];

*/

		s_dot->MnPo[n] = p->trPo[n]*(s->G[n]+LIGHT*p->lono[n]*19.9*p->lta[n]*(1.0-s->ltn[n]))+5.0*p->CtrPo[n]*s->CRE[n]*s->G[n]-p->tmc[n]*s->MnPo[n]-p->umPo[n]*s->MnPo[n];
		s_dot->McPo[n] = -(p->umPo[n]*s->McPo[n])+p->tmc[n]*s->MnPo[n];
		s_dot->MnPt[n] = p->trPt[n]*(s->G[n]+LIGHT*p->lont[n]*19.9*p->lta[n]*(1.0-s->ltn[n]))+5.0*p->CtrPt[n]*s->CRE[n]*s->G[n]-p->tmc[n]*s->MnPt[n]-p->umPt[n]*s->MnPt[n];
		...
		s_dot->cyrev[n] = -((p->nlrev[n]+p->urev[n])*s->cyrev[n])+p->dg[n]*s->cyrevg[n]+p->tlrev[n]*s->McRev[n]+p->nerev[n]*s->revn[n]-p->ag[n]*s->cyrev[n]*s->x00200[n];
		s_dot->revn[n] = p->nlrev[n]*s->cyrev[n]+(-p->nerev[n]-p->urev[n])*s->revn[n]+p->dg[n]*s->revng[n]-p->ag[n]*p->Nf[n]*s->revn[n]*s->x00210[n];
		s_dot->cyrevg[n] = -(s->cyrevg[n]*(p->dg[n]+p->nlrev[n]+p->urev[n]+s->gto[n]))+p->nerev[n]*s->revng[n]+p->ag[n]*s->cyrev[n]*s->x00200[n];
		...
		s_dot->x00100[n] = p->lne[n]*s->x00110[n]+p->upu[n]*(s->x10100[n]+s->x30100[n]+s->x30300[n]+s->x50100[n]+s->x50300[n])+p->up[n]*(s->x20100[n]+s->x40100[n]+s->x40300[n]+s->x60100[n]+s->x60300[n])-p->ac[n]*s->x00100[n]*(s->x10000[n]+s->x20000[n]+s->x21000[n]+s->x22000[n]+s->x30000[n]+s->x40000[n]+s->x41000[n]+s->x42000[n]+s->x50000[n]+s->x51000[n]+s->x52000[n]+s->x60000[n]+s->x61000[n]+s->x62000[n])+p->dc[n]*(s->x10100[n]+s->x20100[n]+s->x21100[n]+s->x22100[n]+s->x30100[n]+s->x40100[n]+s->x41100[n]+s->x42100[n]+s->x50100[n]+s->x51100[n]+s->x52100[n]+s->x60100[n]+s->x61100[n]+s->x62100[n])-p->ac[n]*s->x00100[n]*(s->x30200[n]+s->x40200[n]+s->x41200[n]+s->x42200[n]+s->x50200[n]+s->x51200[n]+s->x52200[n]+s->x60200[n]+s->x61200[n]+s->x62200[n])+p->dc[n]*(s->x30300[n]+s->x40300[n]+s->x41300[n]+s->x42300[n]+s->x50300[n]+s->x51300[n]+s->x52300[n]+s->x60300[n]+s->x61300[n]+s->x62300[n]);
		...
		s_dot->x10000[n] = p->tlp[n]*s->McPo[n]-p->upu[n]*s->x10000[n]-p->ac[n]*s->x00100[n]*s->x10000[n]+p->dc[n]*s->x10100[n];
		s_dot->x10100[n] = p->ac[n]*s->x00100[n]*s->x10000[n]-p->dc[n]*s->x10100[n]-p->hoo[n]*s->x10100[n]-p->upu[n]*s->x10100[n];
		s_dot->x20000[n] = -(p->nl[n]*s->x20000[n])-p->up[n]*s->x20000[n]-p->ac[n]*s->x00100[n]*s->x20000[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x20000[n]+p->ne[n]*s->x20010[n]+p->dc[n]*s->x20100[n]+p->dr[n]*(s->x21000[n]+s->x22000[n]);
		...
		s_dot->x20100[n] = p->hoo[n]*s->x10100[n]+p->ac[n]*s->x00100[n]*s->x20000[n]-p->dc[n]*s->x20100[n]-p->nl[n]*s->x20100[n]-p->up[n]*s->x20100[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x20100[n]+p->ne[n]*s->x20110[n]+p->dr[n]*(s->x21100[n]+s->x22100[n]);
		...
		s_dot->x21000[n] = p->ar[n]*s->x01000[n]*s->x20000[n]-p->dr[n]*s->x21000[n]-p->nl[n]*s->x21000[n]-p->ac[n]*s->x00100[n]*s->x21000[n]+p->ne[n]*s->x21010[n]+p->dc[n]*s->x21100[n];
		...
		s_dot->x21100[n] = p->ar[n]*s->x01000[n]*s->x20100[n]+p->ac[n]*s->x00100[n]*s->x21000[n]-p->dc[n]*s->x21100[n]-p->dr[n]*s->x21100[n]-p->nl[n]*s->x21100[n]+p->ne[n]*s->x21110[n];
		...
		s_dot->x22000[n] = p->ar[n]*s->x02000[n]*s->x20000[n]-p->dr[n]*s->x22000[n]-p->nl[n]*s->x22000[n]-p->ac[n]*s->x00100[n]*s->x22000[n]+p->ne[n]*s->x22010[n]+p->dc[n]*s->x22100[n];
		...
		s_dot->x22100[n] = p->ar[n]*s->x02000[n]*s->x20100[n]+p->ac[n]*s->x00100[n]*s->x22000[n]-p->dc[n]*s->x22100[n]-p->dr[n]*s->x22100[n]-p->nl[n]*s->x22100[n]+p->ne[n]*s->x22110[n];
		...
		s_dot->x30000[n] = p->tlp[n]*s->McPt[n]-p->upu[n]*s->x30000[n]-p->ac[n]*s->x00100[n]*s->x30000[n]-p->agp[n]*s->x00200[n]*s->x30000[n]+p->dc[n]*s->x30100[n]+p->dg[n]*s->x30200[n];
		s_dot->x30100[n] = p->ac[n]*s->x00100[n]*s->x30000[n]-p->dc[n]*s->x30100[n]-p->hto[n]*s->x30100[n]-p->upu[n]*s->x30100[n]-p->agp[n]*s->x00200[n]*s->x30100[n]+p->dg[n]*s->x30300[n];
		s_dot->x30200[n] = p->agp[n]*s->x00200[n]*s->x30000[n]-p->dg[n]*s->x30200[n]-p->upu[n]*s->x30200[n]-s->gto[n]*s->x30200[n]-p->ac[n]*s->x00100[n]*s->x30200[n]+p->dc[n]*s->x30300[n];
		s_dot->x30300[n] = p->agp[n]*s->x00200[n]*s->x30100[n]+p->ac[n]*s->x00100[n]*s->x30200[n]-p->dc[n]*s->x30300[n]-p->dg[n]*s->x30300[n]-p->hto[n]*s->x30300[n]-p->upu[n]*s->x30300[n]-s->gto[n]*s->x30300[n];
		s_dot->x40000[n] = -(p->nl[n]*s->x40000[n])-p->up[n]*s->x40000[n]-p->ac[n]*s->x00100[n]*s->x40000[n]-p->agp[n]*s->x00200[n]*s->x40000[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x40000[n]+p->ne[n]*s->x40010[n]+p->dc[n]*s->x40100[n]+p->dg[n]*s->x40200[n]+p->dr[n]*(s->x41000[n]+s->x42000[n]);
		...
		s_dot->x40100[n] = p->hto[n]*s->x30100[n]+p->ac[n]*s->x00100[n]*s->x40000[n]-p->dc[n]*s->x40100[n]-p->nl[n]*s->x40100[n]-p->up[n]*s->x40100[n]-p->agp[n]*s->x00200[n]*s->x40100[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x40100[n]+p->ne[n]*s->x40110[n]+p->dg[n]*s->x40300[n]+p->dr[n]*(s->x41100[n]+s->x42100[n]);
		...
		s_dot->x40200[n] = p->agp[n]*s->x00200[n]*s->x40000[n]-p->dg[n]*s->x40200[n]-p->nl[n]*s->x40200[n]-p->up[n]*s->x40200[n]-s->gto[n]*s->x40200[n]-p->ac[n]*s->x00100[n]*s->x40200[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x40200[n]+p->ne[n]*s->x40210[n]+p->dc[n]*s->x40300[n]+p->dr[n]*(s->x41200[n]+s->x42200[n]);
		...
		s_dot->x40300[n] = p->hto[n]*s->x30300[n]+p->agp[n]*s->x00200[n]*s->x40100[n]+p->ac[n]*s->x00100[n]*s->x40200[n]-p->dc[n]*s->x40300[n]-p->dg[n]*s->x40300[n]-p->nl[n]*s->x40300[n]-p->up[n]*s->x40300[n]-s->gto[n]*s->x40300[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x40300[n]+p->ne[n]*s->x40310[n]+p->dr[n]*(s->x41300[n]+s->x42300[n]);
		...
		s_dot->x41000[n] = p->ar[n]*s->x01000[n]*s->x40000[n]-p->dr[n]*s->x41000[n]-p->nl[n]*s->x41000[n]-p->ac[n]*s->x00100[n]*s->x41000[n]-p->agp[n]*s->x00200[n]*s->x41000[n]+p->ne[n]*s->x41010[n]+p->dc[n]*s->x41100[n]+p->dg[n]*s->x41200[n];
		...
		s_dot->x41100[n] = p->ar[n]*s->x01000[n]*s->x40100[n]+p->ac[n]*s->x00100[n]*s->x41000[n]-p->dc[n]*s->x41100[n]-p->dr[n]*s->x41100[n]-p->nl[n]*s->x41100[n]-p->agp[n]*s->x00200[n]*s->x41100[n]+p->ne[n]*s->x41110[n]+p->dg[n]*s->x41300[n];
		...
		s_dot->x41200[n] = p->ar[n]*s->x01000[n]*s->x40200[n]+p->agp[n]*s->x00200[n]*s->x41000[n]-p->dg[n]*s->x41200[n]-p->dr[n]*s->x41200[n]-p->nl[n]*s->x41200[n]-s->gto[n]*s->x41200[n]-p->ac[n]*s->x00100[n]*s->x41200[n]+p->ne[n]*s->x41210[n]+p->dc[n]*s->x41300[n];
		...
		s_dot->x41300[n] = p->ar[n]*s->x01000[n]*s->x40300[n]+p->agp[n]*s->x00200[n]*s->x41100[n]+p->ac[n]*s->x00100[n]*s->x41200[n]-p->dc[n]*s->x41300[n]-p->dg[n]*s->x41300[n]-p->dr[n]*s->x41300[n]-p->nl[n]*s->x41300[n]-s->gto[n]*s->x41300[n]+p->ne[n]*s->x41310[n];
		...
		s_dot->x42000[n] = p->ar[n]*s->x02000[n]*s->x40000[n]-p->dr[n]*s->x42000[n]-p->nl[n]*s->x42000[n]-p->ac[n]*s->x00100[n]*s->x42000[n]-p->agp[n]*s->x00200[n]*s->x42000[n]+p->ne[n]*s->x42010[n]+p->dc[n]*s->x42100[n]+p->dg[n]*s->x42200[n];
		...
		s_dot->x42100[n] = p->ar[n]*s->x02000[n]*s->x40100[n]+p->ac[n]*s->x00100[n]*s->x42000[n]-p->dc[n]*s->x42100[n]-p->dr[n]*s->x42100[n]-p->nl[n]*s->x42100[n]-p->agp[n]*s->x00200[n]*s->x42100[n]+p->ne[n]*s->x42110[n]+p->dg[n]*s->x42300[n];
		...
		s_dot->x42200[n] = p->ar[n]*s->x02000[n]*s->x40200[n]+p->agp[n]*s->x00200[n]*s->x42000[n]-p->dg[n]*s->x42200[n]-p->dr[n]*s->x42200[n]-p->nl[n]*s->x42200[n]-s->gto[n]*s->x42200[n]-p->ac[n]*s->x00100[n]*s->x42200[n]+p->ne[n]*s->x42210[n]+p->dc[n]*s->x42300[n];
		...
		s_dot->x42300[n] = p->ar[n]*s->x02000[n]*s->x40300[n]+p->agp[n]*s->x00200[n]*s->x42100[n]+p->ac[n]*s->x00100[n]*s->x42200[n]-p->dc[n]*s->x42300[n]-p->dg[n]*s->x42300[n]-p->dr[n]*s->x42300[n]-p->nl[n]*s->x42300[n]-s->gto[n]*s->x42300[n]+p->ne[n]*s->x42310[n];
		...
		s_dot->x50000[n] = -(p->nl[n]*s->x50000[n])-p->upu[n]*s->x50000[n]-p->ac[n]*s->x00100[n]*s->x50000[n]-p->agp[n]*s->x00200[n]*s->x50000[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x50000[n]+p->ne[n]*s->x50010[n]+p->dc[n]*s->x50100[n]+p->dg[n]*s->x50200[n]+p->dr[n]*(s->x51000[n]+s->x52000[n]);
		...
		s_dot->x50100[n] = p->ac[n]*s->x00100[n]*s->x50000[n]-p->dc[n]*s->x50100[n]-p->hto[n]*s->x50100[n]-p->nl[n]*s->x50100[n]-p->upu[n]*s->x50100[n]-p->agp[n]*s->x00200[n]*s->x50100[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x50100[n]+p->ne[n]*s->x50110[n]+p->dg[n]*s->x50300[n]+p->dr[n]*(s->x51100[n]+s->x52100[n]);
		...
		s_dot->x50200[n] = s->gto[n]*s->x30200[n]+p->agp[n]*s->x00200[n]*s->x50000[n]-p->dg[n]*s->x50200[n]-p->nl[n]*s->x50200[n]-p->upu[n]*s->x50200[n]-p->ac[n]*s->x00100[n]*s->x50200[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x50200[n]+p->ne[n]*s->x50210[n]+p->dc[n]*s->x50300[n]+p->dr[n]*(s->x51200[n]+s->x52200[n]);
		...
		s_dot->x50300[n] = s->gto[n]*s->x30300[n]+p->agp[n]*s->x00200[n]*s->x50100[n]+p->ac[n]*s->x00100[n]*s->x50200[n]-p->dc[n]*s->x50300[n]-p->dg[n]*s->x50300[n]-p->hto[n]*s->x50300[n]-p->nl[n]*s->x50300[n]-p->upu[n]*s->x50300[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x50300[n]+p->ne[n]*s->x50310[n]+p->dr[n]*(s->x51300[n]+s->x52300[n]);
		...
		s_dot->x51000[n] = p->ar[n]*s->x01000[n]*s->x50000[n]-p->dr[n]*s->x51000[n]-p->nl[n]*s->x51000[n]-p->ac[n]*s->x00100[n]*s->x51000[n]-p->agp[n]*s->x00200[n]*s->x51000[n]+p->ne[n]*s->x51010[n]+p->dc[n]*s->x51100[n]+p->dg[n]*s->x51200[n];
		...
		s_dot->x51100[n] = p->ar[n]*s->x01000[n]*s->x50100[n]+p->ac[n]*s->x00100[n]*s->x51000[n]-p->dc[n]*s->x51100[n]-p->dr[n]*s->x51100[n]-p->nl[n]*s->x51100[n]-p->agp[n]*s->x00200[n]*s->x51100[n]+p->ne[n]*s->x51110[n]+p->dg[n]*s->x51300[n];
		...
		s_dot->x51200[n] = p->ar[n]*s->x01000[n]*s->x50200[n]+p->agp[n]*s->x00200[n]*s->x51000[n]-p->dg[n]*s->x51200[n]-p->dr[n]*s->x51200[n]-p->nl[n]*s->x51200[n]-p->ac[n]*s->x00100[n]*s->x51200[n]+p->ne[n]*s->x51210[n]+p->dc[n]*s->x51300[n];
		...
		s_dot->x51300[n] = p->ar[n]*s->x01000[n]*s->x50300[n]+p->agp[n]*s->x00200[n]*s->x51100[n]+p->ac[n]*s->x00100[n]*s->x51200[n]-p->dc[n]*s->x51300[n]-p->dg[n]*s->x51300[n]-p->dr[n]*s->x51300[n]-p->nl[n]*s->x51300[n]+p->ne[n]*s->x51310[n];
		...
		s_dot->x52000[n] = p->ar[n]*s->x02000[n]*s->x50000[n]-p->dr[n]*s->x52000[n]-p->nl[n]*s->x52000[n]-p->ac[n]*s->x00100[n]*s->x52000[n]-p->agp[n]*s->x00200[n]*s->x52000[n]+p->ne[n]*s->x52010[n]+p->dc[n]*s->x52100[n]+p->dg[n]*s->x52200[n];
		...
		s_dot->x52100[n] = p->ar[n]*s->x02000[n]*s->x50100[n]+p->ac[n]*s->x00100[n]*s->x52000[n]-p->dc[n]*s->x52100[n]-p->dr[n]*s->x52100[n]-p->nl[n]*s->x52100[n]-p->agp[n]*s->x00200[n]*s->x52100[n]+p->ne[n]*s->x52110[n]+p->dg[n]*s->x52300[n];
		...
		s_dot->x52200[n] = p->ar[n]*s->x02000[n]*s->x50200[n]+p->agp[n]*s->x00200[n]*s->x52000[n]-p->dg[n]*s->x52200[n]-p->dr[n]*s->x52200[n]-p->nl[n]*s->x52200[n]-p->ac[n]*s->x00100[n]*s->x52200[n]+p->ne[n]*s->x52210[n]+p->dc[n]*s->x52300[n];
		...
		s_dot->x52300[n] = p->ar[n]*s->x02000[n]*s->x50300[n]+p->agp[n]*s->x00200[n]*s->x52100[n]+p->ac[n]*s->x00100[n]*s->x52200[n]-p->dc[n]*s->x52300[n]-p->dg[n]*s->x52300[n]-p->dr[n]*s->x52300[n]-p->nl[n]*s->x52300[n]+p->ne[n]*s->x52310[n];
		...
		s_dot->x60000[n] = -(p->nl[n]*s->x60000[n])-p->up[n]*s->x60000[n]-p->ac[n]*s->x00100[n]*s->x60000[n]-p->agp[n]*s->x00200[n]*s->x60000[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x60000[n]+p->ne[n]*s->x60010[n]+p->dc[n]*s->x60100[n]+p->dg[n]*s->x60200[n]+p->dr[n]*(s->x61000[n]+s->x62000[n]);
		...
		s_dot->x60100[n] = p->hto[n]*s->x50100[n]+p->ac[n]*s->x00100[n]*s->x60000[n]-p->dc[n]*s->x60100[n]-p->nl[n]*s->x60100[n]-p->up[n]*s->x60100[n]-p->agp[n]*s->x00200[n]*s->x60100[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x60100[n]+p->ne[n]*s->x60110[n]+p->dg[n]*s->x60300[n]+p->dr[n]*(s->x61100[n]+s->x62100[n]);
		...
		s_dot->x60200[n] = s->gto[n]*s->x40200[n]+p->agp[n]*s->x00200[n]*s->x60000[n]-p->dg[n]*s->x60200[n]-p->nl[n]*s->x60200[n]-p->up[n]*s->x60200[n]-p->ac[n]*s->x00100[n]*s->x60200[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x60200[n]+p->ne[n]*s->x60210[n]+p->dc[n]*s->x60300[n]+p->dr[n]*(s->x61200[n]+s->x62200[n]);
		...
		s_dot->x60300[n] = s->gto[n]*s->x40300[n]+p->hto[n]*s->x50300[n]+p->agp[n]*s->x00200[n]*s->x60100[n]+p->ac[n]*s->x00100[n]*s->x60200[n]-p->dc[n]*s->x60300[n]-p->dg[n]*s->x60300[n]-p->nl[n]*s->x60300[n]-p->up[n]*s->x60300[n]-p->ar[n]*(s->x01000[n]+s->x02000[n])*s->x60300[n]+p->ne[n]*s->x60310[n]+p->dr[n]*(s->x61300[n]+s->x62300[n]);
		...
		s_dot->x61000[n] = p->ar[n]*s->x01000[n]*s->x60000[n]-p->dr[n]*s->x61000[n]-p->nl[n]*s->x61000[n]-p->ac[n]*s->x00100[n]*s->x61000[n]-p->agp[n]*s->x00200[n]*s->x61000[n]+p->ne[n]*s->x61010[n]+p->dc[n]*s->x61100[n]+p->dg[n]*s->x61200[n];
		...
		s_dot->x61100[n] = p->ar[n]*s->x01000[n]*s->x60100[n]+p->ac[n]*s->x00100[n]*s->x61000[n]-p->dc[n]*s->x61100[n]-p->dr[n]*s->x61100[n]-p->nl[n]*s->x61100[n]-p->agp[n]*s->x00200[n]*s->x61100[n]+p->ne[n]*s->x61110[n]+p->dg[n]*s->x61300[n];
		...
		s_dot->x61200[n] = s->gto[n]*s->x41200[n]+p->ar[n]*s->x01000[n]*s->x60200[n]+p->agp[n]*s->x00200[n]*s->x61000[n]-p->dg[n]*s->x61200[n]-p->dr[n]*s->x61200[n]-p->nl[n]*s->x61200[n]-p->ac[n]*s->x00100[n]*s->x61200[n]+p->ne[n]*s->x61210[n]+p->dc[n]*s->x61300[n];
		...
		s_dot->x61300[n] = s->gto[n]*s->x41300[n]+p->ar[n]*s->x01000[n]*s->x60300[n]+p->agp[n]*s->x00200[n]*s->x61100[n]+p->ac[n]*s->x00100[n]*s->x61200[n]-p->dc[n]*s->x61300[n]-p->dg[n]*s->x61300[n]-p->dr[n]*s->x61300[n]-p->nl[n]*s->x61300[n]+p->ne[n]*s->x61310[n];
		...
		s_dot->x62000[n] = p->ar[n]*s->x02000[n]*s->x60000[n]-p->dr[n]*s->x62000[n]-p->nl[n]*s->x62000[n]-p->ac[n]*s->x00100[n]*s->x62000[n]-p->agp[n]*s->x00200[n]*s->x62000[n]+p->ne[n]*s->x62010[n]+p->dc[n]*s->x62100[n]+p->dg[n]*s->x62200[n];
		...
		s_dot->x62100[n] = p->ar[n]*s->x02000[n]*s->x60100[n]+p->ac[n]*s->x00100[n]*s->x62000[n]-p->dc[n]*s->x62100[n]-p->dr[n]*s->x62100[n]-p->nl[n]*s->x62100[n]-p->agp[n]*s->x00200[n]*s->x62100[n]+p->ne[n]*s->x62110[n]+p->dg[n]*s->x62300[n];
		...
		s_dot->x62200[n] = s->gto[n]*s->x42200[n]+p->ar[n]*s->x02000[n]*s->x60200[n]+p->agp[n]*s->x00200[n]*s->x62000[n]-p->dg[n]*s->x62200[n]-p->dr[n]*s->x62200[n]-p->nl[n]*s->x62200[n]-p->ac[n]*s->x00100[n]*s->x62200[n]+p->ne[n]*s->x62210[n]+p->dc[n]*s->x62300[n];
		...
		s_dot->x62300[n] = s->gto[n]*s->x42300[n]+p->ar[n]*s->x02000[n]*s->x60300[n]+p->agp[n]*s->x00200[n]*s->x62100[n]+p->ac[n]*s->x00100[n]*s->x62200[n]-p->dc[n]*s->x62300[n]-p->dg[n]*s->x62300[n]-p->dr[n]*s->x62300[n]-p->nl[n]*s->x62300[n]+p->ne[n]*s->x62310[n];
...
//		s_dot->vip[n] = 100.0-p->uv[n]*s->vip[n]-p->vbin[n]*(V00+s->V01[n]+s->V02[n])*s->vip[n]+p->unvbin[n]*(s->V10[n]+s->V11[n]+s->V12[n]);
		s_dot->vip[n] = CPL*6000.0*p->vpr[n]*input[n]/upstream[n]-p->uv[n]*s->vip[n]-p->vbin[n]*(V00+s->V01[n]+s->V02[n])*s->vip[n]+p->unvbin[n]*(s->V10[n]+s->V11[n]+s->V12[n]);
...
/*		double VPAC = p->Vt[n]-s->VPACLI[n]-s->VPACI[n]-s->VPACL[n]; // free receptor
		double I = s->x01000[n]; // inhibitor */
//		s_dot->v[n] = 3.0*(.5+.5*sin(2.0*PI/24.0*(t-(double)n/(ncells-1)*24.0)))-p->uv[n]*s->v[n]-p->vbin[n]*VPAC*s->v[n]+p->unvbin[n]*s->VPACL[n]-p->vbin[n]*s->VPACI[n]*s->v[n]+p->unvbin[n]*s->VPACLI[n];
//		s_dot->v[n] = s->Gc[n]-p->uv[n]*s->v[n]-p->vbin[n]*s->VPAC[n]*s->v[n]+p->unvbin[n]*s->VPACL[n]-p->vbin[n]*s->VPACI[n]*s->v[n]+p->unvbin[n]*(p->Vt[n]-s->VPAC[n]-s->VPACI[n]-s->VPACL[n]);
//		s_dot->v[n] = 3.0*(.5+.5*sin(2.0*PI/24.0*t))-p->uv[n]*s->v[n]-p->vbin[n]*VPAC*s->v[n]+p->unvbin[n]*s->VPACL[n]-p->vbin[n]*s->VPACI[n]*s->v[n]+p->unvbin[n]*s->VPACLI[n];
//		s_dot->v[n] = 6000.0*x->cac[n]-p->uv[n]*s->v[n]-p->vbin[n]*VPAC*s->v[n]+p->unvbin[n]*s->VPACL[n]-p->vbin[n]*s->VPACI[n]*s->v[n]+p->unvbin[n]*s->VPACLI[n];

/*		s_dot->v[n] = 6000.0*input[n]/upstream[n]-p->uv[n]*s->v[n]-p->vbin[n]*VPAC*s->v[n]+p->unvbin[n]*s->VPACL[n]-p->vbin[n]*s->VPACI[n]*s->v[n]+p->unvbin[n]*s->VPACLI[n];
		s_dot->VPACI[n] = p->cvbin[n]*VPAC*I-p->uncvbin[n]*s->VPACI[n]-p->vbin[n]*s->VPACI[n]*s->v[n]+p->unvbin[n]*s->VPACLI[n];
		s_dot->VPACL[n] = p->vbin[n]*VPAC*s->v[n]-p->unvbin[n]*s->VPACL[n]-p->cvbin[n]*s->VPACL[n]*I+p->uncvbin[n]*s->VPACLI[n];
		s_dot->VPACLI[n] = p->cvbin[n]*s->VPACL[n]*I+p->vbin[n]*s->VPACI[n]*s->v[n]-(p->uncvbin[n]+p->unvbin[n])*s->VPACLI[n];
		s_dot->cAMP[n] = p->vs[n]*s->VPACL[n]-p->us[n]*s->cAMP[n];
		s_dot->CREB[n] = p->vs[n]*s->cAMP[n]-p->us[n]*s->CREB[n];//s->EPAC[n]+x->cac[n];
		s_dot->CRE[n] = p->sbin[n]*s->CREB[n]*(1.0-s->CRE[n])-p->unsbin[n]*s->CRE[n];
*/

//		s_dot->EPAC[n] = s->cAMP[n]-s->EPAC[n];
	}
}
...
__global__ void rk4(Mstate *s, Mstate *k1, Mstate *k2, Mstate *k3, Mstate *k4, double t) 
{
	...
	// add stim to rhs of whichever state variable you want to add stimulus to //
/*	        double stim = 0;
                double offset = 3.0*7.0;
                double stim_t = 61.5+offset;
                if (t == stim_t)
                        stim = 20;
*/
...
__global__ void record_result(int i, Mresult *r, Mstate *s) 
{
	// Record results
	int n;
	int tid = blockIdx.x * blockDim.x + threadIdx.x;
...
void rk4_wrapper(Mstate *s, Mstate *k1, Mstate *k2, Mstate *k3, Mstate *k4, double t) {
	rk4 <<< NBLOCKS, NTHREADS >>> (s, k1, k2, k3, k4, t);
}

void record_result_wrapper(int i, Mresult *r, Mstate *s) {
	record_result <<< NBLOCKS, NTHREADS >>> (i, r, s);
}
