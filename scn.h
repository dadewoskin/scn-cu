...
struct Estate{
	double V[ncells], m[ncells], h[ncells], n[ncells], rl[ncells], rnl[ncells], fnl[ncells], s[ncells], cas[ncells], cac[ncells], out[ncells], gaba[ncells], y[ncells];
};

struct Eparameters{
	double c[ncells], gna[ncells], gk[ncells], gcal[ncells], gcanl[ncells], gkca[ncells], gkleak[ncells], gnaleak[ncells], Ena[ncells], Ek[ncells], Eca[ncells], lambda[ncells], clk[ncells], Egaba[ncells];
};
